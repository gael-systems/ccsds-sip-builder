 ...
 * </p>
 * <p>
 * Originally from <a href="http://jakarta.apache.org/turbine/">Turbine</a> and
 * the GenerationJavaCore library.
 * </p>
 * 
...
public class StringUtils
{
    ...
    * </p>
    * <p>
    * This constructor is public to permit tools that require a JavaBean manager
    * to operate.
    * </p>
    */
   public StringUtils()
    ...
    * </p>
    * <p>
    * <strong>Note:</strong> In future releases, this method will no longer trim
    * the input string such that it works complementary to
   ...
   public static String join(final Object[] array, String separator)
   {
      ...
      final int bufSize =
         (arraySize == 0 ? 0 : (array[0].toString().length() + separator
               .length()) * arraySize);
   ...
   public static String join(final Iterator iterator, String separator)
   {
      ...
      final StringBuffer buf = new StringBuffer(256); // Java default is 16,
                                                      // probably too small
    ...
    */
   public static String replaceOnce(final String text, final char repl,
         final char with)
   {
    ...
    * @return the text with any replacements processed
    */
   public static String replace(final String text, final char repl,
         final char with)
   {
      return replace(text, repl, with, -1);
   }
    ...
    * @return the text with any replacements processed
    */
   public static String replaceOnce(final String text, final String repl,
         final String with)
   {
      return replace(text, repl, with, 1);
   }
    ...
    */
   public static String overlayString(final String text, final String overlay,
   ...
   /**
    * <p>
    * Remove the first value of a supplied String, and everything before it from
    * a String.
    * </p>
    * 
    * @param str String to chomp from
    ...
    * </p>
    * <p>
    * That is, convert the first character into lower-case. <code>null</code> is
    ...
    * </p>
    * <p>
    * That is, convert the first character into title-case. <code>null</code> is
    * returned as <code>null</code>.
    * </p>
    * 
    ...
    */
   public static String getNestedString(final String str, final String open,
         final String close)
   {
      if (str == null)
      {
    ...
    * @return the reversed String
    */
   public static String reverseDelimitedString(final String str,
   ...
   public static String capitalizeFirstLetter(final String data)
   {
      final char firstLetter =
         Character.toTitleCase(data.substring(0, 1).charAt(0));
   ...
   {
      final char firstLetter =
         Character.toLowerCase(data.substring(0, 1).charAt(0));
    ...
    * @see #quoteAndEscape(String, char, char[], char[], char, boolean)
    */
   public static String quoteAndEscape(final String source,
         final char quoteChar, final char[] quotingTriggers)
   {
      return quoteAndEscape(source, quoteChar, new char[] { quoteChar },
    ...
    */
   public static String quoteAndEscape(final String source,
         final char quoteChar, final char[] escapedChars, final char escapeChar,
         final boolean force)
   {
    ...
    */
   public static String quoteAndEscape(final String source,
         final char quoteChar, final char[] escapedChars,
    ...
    * @since 1.5.1
    */
   public static String escape(final String source, final char[] escapedChars,
